...
// modules
import { Form, Descriptions, Select, Row, Col, Button } from 'antd';
import { FormComponentProps } from 'antd/lib/form';
import TextArea from 'antd/lib/input/TextArea';

function MemoForm(props: FormComponentProps) {
  const { form } = props;
...
export default Form.create<FormComponentProps>()(MemoForm);
