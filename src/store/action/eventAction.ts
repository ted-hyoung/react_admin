...
// 이벤트 배송비 설정 등록
export const CREATE_EVENT_SHIPPING_REQUEST = 'event/CREATE_EVENT_SHIPPING_REQUEST';
export const CREATE_EVENT_SHIPPING_SUCCESS = 'event/CREATE_EVENT_SHIPPING_SUCCESS';
export const CREATE_EVENT_SHIPPING_FAILURE = 'event/CREATE_EVENT_SHIPPING_FAILURE';
