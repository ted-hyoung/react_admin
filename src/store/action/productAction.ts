...
// 상품 정보 생성
export const CREATE_PRODUCT_NOTICE_REQUEST = 'product/CREATE_PRODUCT_NOTICE_REQUEST';
export const CREATE_PRODUCT_NOTICE_SUCCESS = 'product/CREATE_PRODUCT_NOTICE_SUCCESS';
export const CREATE_PRODUCT_NOTICE_FAILURE = 'product/CREATE_PRODUCT_NOTICE_FAILURE';

// 상품 정보 수정
export const UPDATE_PRODUCT_NOTICE_REQUEST = 'product/UPDATE_PRODUCT_NOTICE_REQUEST';
export const UPDATE_PRODUCT_NOTICE_SUCCESS = 'product/UPDATE_PRODUCT_NOTICE_SUCCESS';
export const UPDATE_PRODUCT_NOTICE_FAILURE = 'product/UPDATE_PRODUCT_NOTICE_FAILURE';

// 상품 정보 수정
export const DELETED_PRODUCT_NOTICE_REQUEST = 'product/DELETED_PRODUCT_NOTICE_REQUEST';
export const DELETED_PRODUCT_NOTICE_SUCCESS = 'product/DELETED_PRODUCT_NOTICE_SUCCESS';
export const DELETED_PRODUCT_NOTICE_FAILURE = 'product/DELETED_PRODUCT_NOTICE_FAILURE';