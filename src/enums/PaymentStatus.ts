...
export const DEFAULT_PAYMENT_STATUSES_TOTAL = ['READY', 'CANCEL', 'COMPLETE', 'REFUND_REQUEST', 'REFUND_COMPLETE', 'VIRTUAL_ACCOUNT_READY', 'VIRTUAL_ACCOUNT_COMPLETE', 'VIRTUAL_ACCOUNT_REFUND_REQUEST', 'VIRTUAL_ACCOUNT_REFUND_COMPLETE'];
