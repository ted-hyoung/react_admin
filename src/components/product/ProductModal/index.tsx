    ...
    <div className="product-modal" onClick={() => onClickProductModalOpen}>
      ...
      <Row>
        ...
        <Col span={8} className="product-modal-col-8">
          <Input name="productName" value={selectedProduct.productName} placeholder="텍스트 입력" onChange={e => onChangeProductValue(e)} maxLength={20} />
        </Col>
      ...
      <Row>
        ...
        <Col span={8} className="product-modal-col-8">
          <Input className="product-modal-input"  name="normalSalesPrice" type="Number" value={selectedProduct.normalSalesPrice} onChange={e => onChangeProductValue(e)} />
        </Col>
        ...
        <Col span={8} className="product-modal-col-8">
          <Input className="product-modal-input"  name="discountSalesPrice" type="Number" value={selectedProduct.discountSalesPrice} onChange={e => onChangeProductValue(e)} />
        </Col>
        <Col span={1} className="product-modal-explanation">
          원
        </Col>
      ...
      <div>
        {selectedProduct.enableOption}</div>
      <Row>
        <Col span={3} className="product-modal-col-3">
          <Text>옵션</Text>
        </Col>
        <Col span={8} className="product-modal-col-8">
          <Select defaultValue={selectedProduct.enableOption ? 0 : 1} value={selectedProduct.enableOption ? 0 : 1} onChange={onChangeEnableOption} style={{ width: 100 }}>
